...
(function() {
    ...
    const BRAND_IMAGE_SOURCE = "src/img/app/logo.png";
    // controller
    ...
    .constant("_BRAND_IMG_SRC", BRAND_IMAGE_SOURCE)
    .constant("_MENU_CATEGORIES_ROOT_URL", MENU_CATEGORIES_ROOT_URL)
    .constant("_MENU_ITEMS_ROOT_URL", MENU_ITEMS_ROOT_URL)
    // controller
    .constant("_HEADER_BRAND_CTRL_NAME", HEADER_BRAND_CONTROLLER_NAME)
    .constant("_HEADER_LINKS_CTRL_NAME", HEADER_LINKS_CONTROLLER_NAME)
    .constant("_FOOTER_LINKS_CTRL_NAME", FOOTER_LINKS_CONTROLLER_NAME)
    .constant("_FOOTER_SOCIAL_CTRL_NAME", FOOTER_SOCIAL_CONTROLLER_NAME)
    .constant("_FOOTER_LOGOUT_CTRL_NAME", FOOTER_LOGOUT_CONTROLLER_NAME)
    // service
    // factory
    ...
    .constant("_DIR_EMPTY_ISOLATED_SCOPE", DIRECTIVE_EMPTY_ISOLATED_SCOPE)
    .constant("_DIR_BIND_TO_CTRL", DIRECTIVE_BIND_TO_CONTROLLER)
    .constant("_DIR_NOT_BIND_TO_CTRL", DIRECTIVE_NOT_BIND_TO_CONTROLLER)
    // component
    .constant("_COMP_REPLACE_FALSE", COMPONENT_REPLACE_FALSE)
    .constant("_LOADING_TEMPLATE_URL", LOADING_TEMPLATE_URL)
    .constant("_LOADING_CTRL_NAME", LOADING_CONTROLLER_NAME)
    ...
    .constant("_HEADER_BRAND_CTRL_AS", HEADER_BRAND_CONTROLLER_AS)
    .constant("_HEADER_LINKS_TEMPLATE_URL", HEADER_LINKS_TEMPLATE_URL)
    .constant("_HEADER_LINKS_CTRL_AS", HEADER_LINKS_CONTROLLER_AS)
    ...
    .constant("_FOOTER_LINKS_CTRL_NAME", FOOTER_LINKS_CONTROLLER_NAME)
    .constant("_FOOTER_LINKS_CTRL_AS", FOOTER_LINKS_CONTROLLER_AS)
    .constant("_FOOTER_SOCIAL_TEMPLATE_URL", FOOTER_SOCIAL_TEMPLATE_URL)
    .constant("_FOOTER_SOCIAL_CTRL_NAME", FOOTER_SOCIAL_CONTROLLER_NAME)
    .constant("_FOOTER_SOCIAL_CTRL_AS", FOOTER_SOCIAL_CONTROLLER_AS)
    ...
    .constant("_FOOTER_LOGOUT_CTRL_AS", FOOTER_LOGOUT_CONTROLLER_AS)
    // routing
